# Ensemble: Jimi Hendrix Experience

## Pairing Context

This music lives in the Jimi Hendrix Experience world: psychedelic rock / power trio. Listen for how the players build the feel together: the groove, the guitar tone, the accents, and the space between parts. The goal is to hear the band as a working ensemble, not just a set of famous songs.

## Players

| Player | Instrument / Role | Wikipedia | Website |
|---|---|---|---|
| [Noel Redding](#noel-redding) | Bass | [Wikipedia][noel-redding-wiki] | — |
| [Jimi Hendrix](#jimi-hendrix) | Guitar | [Wikipedia][jimi-hendrix-wiki] | — |
| [Mitch Mitchell](#mitch-mitchell) | Drums | [Wikipedia][mitch-mitchell-wiki] | — |
...
[noel-redding-wiki]: https://en.wikipedia.org/wiki/Noel_Redding
[jimi-hendrix-wiki]: https://en.wikipedia.org/wiki/Jimi_Hendrix
[mitch-mitchell-wiki]: https://en.wikipedia.org/wiki/Mitch_Mitchell
[jimi-hendrix-experience-wiki]: https://en.wikipedia.org/wiki/Jimi_Hendrix_Experience
