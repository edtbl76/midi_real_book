...
Dug Pinnick is the bass voice for the `Extreme` pairing label. In the local ranking corpus, Dug Pinnick is treated as an everyone-else bassist because of melodic heavy groove, vocal-bass coordination, spacious authority. Their core style vocabulary is alternative metal, heavy rock; in this ensemble, that vocabulary is being aimed at heavy funk / alternative metal inside the broader King's X / Extreme / Living Colour lane.

### Timeline

| Period | Bands / Collaborators | Wikipedia | Website | Notes |
|---|---|---|---|---|
| Ensemble focus | Extreme | [Wikipedia][extreme-wiki] | — | Core context for this real-book pairing label. |
...
Ty Tabor is the guitar voice for the `Extreme` pairing label. In the local ranking corpus, Ty Tabor is treated as an everyone-else guitarist because of prog-rock harmonic sensitivity, unconventional note choices, tonal depth. Their core style vocabulary is progressive rock, hard rock; in this ensemble, that vocabulary is being aimed at heavy funk / alternative metal inside the broader King's X / Extreme / Living Colour lane.
...
Nuno Bettencourt is the guitar voice for the `Extreme` pairing label. In the local ranking corpus, Nuno Bettencourt is treated as a virtuoso guitarist because of right-hand percussive technique, tapping vocabulary, string skipping, technical rock phrasing. Their core style vocabulary is hard rock, funk-rock, rock; in this ensemble, that vocabulary is being aimed at heavy funk / alternative metal inside the broader King's X / Extreme / Living Colour lane.
...
Jerry Gaskill appears here as the drums voice for the `Extreme` pairing label. In this ensemble context, the important traits are the player's role in heavy funk / alternative metal, their interaction with the bassist/guitarist core, and the way their vocabulary supports the broader King's X / Extreme / Living Colour lane.
...
| Song | Why Listen |
|---|---|
| [He-Man Woman Hater](https://open.spotify.com/search/He-Man%20Woman%20Hater%20Jerry%20Gaskill%20Extreme) | Listen for dynamic control and how the drummer changes density without losing pulse. |
| [Play with Me](https://open.spotify.com/search/Play%20with%20Me%20Jerry%20Gaskill%20Extreme) | Focus on time feel, subdivision, cymbal placement, and fill discipline. |
| [More Than Words](https://open.spotify.com/search/More%20Than%20Words%20Jerry%20Gaskill%20Extreme) | Listen for how the drum part frames the bass line and sets the ensemble weight. |
| [Pornograffitti](https://open.spotify.com/search/Pornograffitti%20Jerry%20Gaskill%20Extreme) | Track the transitions: fills, pushes, setups, and how sections are announced. |
| [Hole Hearted](https://open.spotify.com/search/Hole%20Hearted%20Jerry%20Gaskill%20Extreme) | Use this for groove architecture rather than just surface-level chops. |
| [Warheads](https://open.spotify.com/search/Warheads%20Jerry%20Gaskill%20Extreme) | Listen for dynamic control and how the drummer changes density without losing pulse. |
| [Take Five](https://open.spotify.com/search/Take%20Five%20Jerry%20Gaskill%20Extreme) | Focus on time feel, subdivision, cymbal placement, and fill discipline. |
| [Good Times Bad Times](https://open.spotify.com/search/Good%20Times%20Bad%20Times%20Jerry%20Gaskill%20Extreme) | Listen for how the drum part frames the bass line and sets the ensemble weight. |
| [Hot for Teacher](https://open.spotify.com/search/Hot%20for%20Teacher%20Jerry%20Gaskill%20Extreme) | Track the transitions: fills, pushes, setups, and how sections are announced. |
| [Digital Man](https://open.spotify.com/search/Digital%20Man%20Jerry%20Gaskill%20Extreme) | Use this for groove architecture rather than just surface-level chops. |
...
[extreme-wiki]: https://en.wikipedia.org/wiki/Extreme
