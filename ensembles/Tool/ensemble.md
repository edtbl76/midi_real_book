...
This music lives in the Tool world: progressive metal. Listen for how the players build the feel together: the groove, the guitar tone, the accents, and the space between parts. The goal is to hear the band as a working ensemble, not just a set of famous songs.

## Players

| Player | Instrument / Role | Wikipedia | Website |
|---|---|---|---|
| [Justin Chancellor](#justin-chancellor) | Bass | [Wikipedia][justin-chancellor-wiki] | — |
| [Adam Jones](#adam-jones) | Guitar | [Wikipedia][adam-jones-wiki] | — |
| [Danny Carey](#danny-carey) | Drums | [Wikipedia][danny-carey-wiki] | — |

---

## Justin Chancellor

Justin Chancellor is a bassist associated with progressive metal, alternative metal. Musically, the important traits here are odd-meter pattern development, hypnotic prog precision, complex polyrhythmic control. In this ensemble: progressive metal. Related listening: Tool.

### Timeline

| Period | Bands / Collaborators | Wikipedia | Website | Notes |
|---|---|---|---|---|
| Ensemble focus | Tool | [Wikipedia][tool-wiki] | — | Main musical setting for this ensemble. |
| Broader work | Tool | — | — | Related artists. |
...
| [Ticks & Leeches](https://open.spotify.com/search/Ticks%20%26%20Leeches%20Justin%20Chancellor%20Tool) | Listen for how the player shapes and attacks each note. |
...
| [Pushit](https://open.spotify.com/search/Pushit%20Justin%20Chancellor%20Tool) | Listen for how the player shapes and attacks each note. |

## Adam Jones

Adam Jones is a guitarist associated with progressive metal, alternative metal. Musically, the important traits here are odd-meter riff architecture, atmospheric layering, dynamics command. In this ensemble: progressive metal. Related listening: Tool.
...
| [Jambi](https://open.spotify.com/search/Jambi%20Adam%20Jones%20Tool) | Listen for comping choices and the way guitar defines the band sound. |
...
| [Rosetta Stoned](https://open.spotify.com/search/Rosetta%20Stoned%20Adam%20Jones%20Tool) | Listen for comping choices and the way guitar defines the band sound. |
...
Danny Carey is a drummer whose playing helps shape this music. Listen for how the drum part affects progressive metal: the feel, the arrangement, the transitions, and the conversation with the bass and guitar. The related listening is Tool.
...
[justin-chancellor-wiki]: https://en.wikipedia.org/wiki/Justin_Chancellor
[adam-jones-wiki]: https://en.wikipedia.org/wiki/Adam_Jones
[danny-carey-wiki]: https://en.wikipedia.org/wiki/Danny_Carey
[tool-wiki]: https://en.wikipedia.org/wiki/Tool
