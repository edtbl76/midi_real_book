...
This ensemble represents the `Plini` pairing label, focusing on the band or collaborator lane that connects the listed players. The target idiom is progressive fusion, with the surrounding context of Plini / Intervals orbit.
...
Simon Grove is the bass voice for the `Plini` pairing label. In the local ranking corpus, Simon Grove is treated as a virtuoso bassist because of modern prog-fusion precision and clean extended-register support. Their core style vocabulary is progressive rock, fusion, prog metal; in this ensemble, that vocabulary is being aimed at progressive fusion inside the broader Plini / Intervals orbit lane.

### Timeline

| Period | Bands / Collaborators | Wikipedia | Website | Notes |
|---|---|---|---|---|
| Ensemble focus | Plini | [Wikipedia][plini-wiki] | — | Core context for this real-book pairing label. |
...
| Song | Why Listen |
|---|---|
| [Heart](https://open.spotify.com/search/Heart%20Simon%20Grove%20Plini) | Listen for fills that answer the vocal or guitar while keeping the groove stable. |
...
Troy Wright appears here as the drums voice for the `Plini` pairing label. In this ensemble context, the important traits are the player's role in progressive fusion, their interaction with the bassist/guitarist core, and the way their vocabulary supports the broader Plini / Intervals orbit lane.
...
| Song | Why Listen |
|---|---|
| [Cascade](https://open.spotify.com/search/Cascade%20Troy%20Wright%20Plini) | Use this for groove architecture rather than just surface-level chops. |
| [Paper Moon](https://open.spotify.com/search/Paper%20Moon%20Troy%20Wright%20Plini) | Listen for dynamic control and how the drummer changes density without losing pulse. |
| [Every Piece Matters](https://open.spotify.com/search/Every%20Piece%20Matters%20Troy%20Wright%20Plini) | Focus on time feel, subdivision, cymbal placement, and fill discipline. |
| [Pastures](https://open.spotify.com/search/Pastures%20Troy%20Wright%20Plini) | Listen for how the drum part frames the bass line and sets the ensemble weight. |
| [Pan](https://open.spotify.com/search/Pan%20Troy%20Wright%20Plini) | Track the transitions: fills, pushes, setups, and how sections are announced. |
| [Impulse Voices](https://open.spotify.com/search/Impulse%20Voices%20Troy%20Wright%20Plini) | Use this for groove architecture rather than just surface-level chops. |
| [Cissy Strut](https://open.spotify.com/search/Cissy%20Strut%20Troy%20Wright%20Plini) | Listen for dynamic control and how the drummer changes density without losing pulse. |
| [Come Together](https://open.spotify.com/search/Come%20Together%20Troy%20Wright%20Plini) | Focus on time feel, subdivision, cymbal placement, and fill discipline. |
| [YYZ](https://open.spotify.com/search/YYZ%20Troy%20Wright%20Plini) | Listen for how the drum part frames the bass line and sets the ensemble weight. |
| [Birdland](https://open.spotify.com/search/Birdland%20Troy%20Wright%20Plini) | Track the transitions: fills, pushes, setups, and how sections are announced. |
