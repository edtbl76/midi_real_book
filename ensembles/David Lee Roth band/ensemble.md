...
This ensemble represents the `David Lee Roth band` pairing label, a stylistic study lane built from the row context rather than a single fixed band. The target idiom is hard rock / shred, with the surrounding context of Mr. Big / David Lee Roth / Shrapnel orbit.
...
[david-lee-roth-band-wiki]: https://en.wikipedia.org/wiki/David_Lee_Roth_band
