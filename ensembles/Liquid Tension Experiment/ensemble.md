...
This ensemble represents the `Liquid Tension Experiment` pairing label, focusing on the band or collaborator lane that connects the listed players. The target idiom is art rock / progressive metal / experimental rock, with the surrounding context of Liquid Tension Experiment / King Crimson / Peter Gabriel.
...
[liquid-tension-experiment-wiki]: https://en.wikipedia.org/wiki/Liquid_Tension_Experiment
