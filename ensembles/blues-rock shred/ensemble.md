# Ensemble: blues-rock shred

## Pairing Context

This ensemble represents the `blues-rock shred` pairing label, a stylistic study lane built from the row context rather than a single fixed band. The target idiom is Texas blues rock, with the surrounding context of Stevie Ray Vaughan / Arc Angels.
...
Kyle Brock is the bass voice for the `blues-rock shred` pairing label. In the local ranking corpus, Kyle Brock is treated as an everyone-else bassist because of Texas blues-rock/fusion support and clean trio pocket. Their core style vocabulary is blues-rock, Texas blues, fusion; in this ensemble, that vocabulary is being aimed at Texas blues rock inside the broader Stevie Ray Vaughan / Arc Angels lane.

### Timeline

| Period | Bands / Collaborators | Wikipedia | Website | Notes |
|---|---|---|---|---|
| Ensemble focus | blues-rock shred | [Wikipedia][blues-rock-shred-wiki] | — | Core context for this real-book pairing label. |
...
Eric Johnson is the guitar voice for the `blues-rock shred` pairing label. In the local ranking corpus, Eric Johnson is treated as a virtuoso guitarist because of violin-tone picking precision, pentatonic/fusion articulation, right-hand cleanliness. Their core style vocabulary is rock, fusion, blues-influenced; in this ensemble, that vocabulary is being aimed at Texas blues rock inside the broader Stevie Ray Vaughan / Arc Angels lane.
...
Blues Saraceno is the guitar voice for the `blues-rock shred` pairing label. In the local ranking corpus, Blues Saraceno is treated as a virtuoso guitarist because of neoclassical shred vocabulary, Shrapnel-era speed and precision, classical phrasing. Their core style vocabulary is neoclassical rock, shred, rock; in this ensemble, that vocabulary is being aimed at Texas blues rock inside the broader Stevie Ray Vaughan / Arc Angels lane.
...
Chris Layton appears here as the drums voice for the `blues-rock shred` pairing label. In this ensemble context, the important traits are the player's role in Texas blues rock, their interaction with the bassist/guitarist core, and the way their vocabulary supports the broader Stevie Ray Vaughan / Arc Angels lane.
...
Reese Wynans appears here as the keyboards voice for the `blues-rock shred` pairing label. In this ensemble context, the important traits are the player's role in Texas blues rock, their interaction with the bassist/guitarist core, and the way their vocabulary supports the broader Stevie Ray Vaughan / Arc Angels lane.
