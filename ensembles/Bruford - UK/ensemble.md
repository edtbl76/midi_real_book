...
This ensemble represents the `Bruford / UK` pairing label, focusing on the band or collaborator lane that connects the listed players. The target idiom is jazz fusion / progressive rock, with the surrounding context of Bruford / UK / Allan Holdsworth band.
