# Ensemble: Deep Purple

## Context

This music lives in the Deep Purple world: classic hard rock. Listen for how the players build the feel together: the groove, the guitar tone, the accents, and the space between parts. The goal is to hear the band as a working ensemble, not just a set of famous songs.

## Players

| Player | Instrument / Role | Wikipedia | Website |
|---|---|---|---|
| [Roger Glover](#roger-glover) | Bass | [Wikipedia][roger-glover-wiki] | — |
| [Ritchie Blackmore](#ritchie-blackmore) | Guitar | [Wikipedia][ritchie-blackmore-wiki] | — |
| [Ian Paice](#ian-paice) | Drums | [Wikipedia][ian-paice-wiki] | — |
| [Jon Lord](#jon-lord) | Keyboards | [Wikipedia][jon-lord-wiki] | — |

---

## Roger Glover

Roger Glover is a bassist associated with classic hard rock, hard rock. Musically, the important traits here are classic hard-rock riff support, swinging eighths, organ/guitar interplay, driving song-form stamina. In this ensemble: classic hard rock. Related listening: Deep Purple.
...
| Broader work | Deep Purple | — | — | Related artists. |
...
| [Speed King](https://open.spotify.com/search/Speed%20King%20Roger%20Glover%20Deep%20Purple) | Listen for how the player shapes and attacks each note. |
...
| [Into the Fire](https://open.spotify.com/search/Into%20the%20Fire%20Roger%20Glover%20Deep%20Purple) | Listen for how the player shapes and attacks each note. |
...
Ritchie Blackmore is a guitarist associated with hard rock, heavy metal, neoclassical-influenced. Musically, the important traits here are proto-neoclassical lead, baroque-influenced phrasing, alternate picking precision, foundational metal vocabulary. In this ensemble: classic hard rock. Related listening: Deep Purple.
...
| [Strange Kind of Woman](https://open.spotify.com/search/Strange%20Kind%20of%20Woman%20Ritchie%20Blackmore%20Deep%20Purple) | Listen for comping choices and the way guitar defines the band sound. |
...
| [Lazy](https://open.spotify.com/search/Lazy%20Ritchie%20Blackmore%20Deep%20Purple) | Listen for comping choices and the way guitar defines the band sound. |

## Ian Paice

Ian Paice is a drummer whose playing helps shape this music. Listen for how the drum part affects classic hard rock: the feel, the arrangement, the transitions, and the conversation with the bass and guitar. The related listening is Deep Purple.
...
Jon Lord is a keyboard player whose playing helps shape this music. Listen for how the keyboard part affects classic hard rock: the feel, the arrangement, the transitions, and the conversation with the bass and guitar. The related listening is Deep Purple.
...
| [Demon's Eye](https://open.spotify.com/search/Demon%27s%20Eye%20Jon%20Lord%20Deep%20Purple) | Listen for how the keys support and color the arrangement. |
...
| [Space Truckin'](https://open.spotify.com/search/Space%20Truckin%27%20Jon%20Lord%20Deep%20Purple) | Listen for how the keys support and color the arrangement. |
...
[roger-glover-wiki]: https://en.wikipedia.org/wiki/Roger_Glover
[ritchie-blackmore-wiki]: https://en.wikipedia.org/wiki/Ritchie_Blackmore
[ian-paice-wiki]: https://en.wikipedia.org/wiki/Ian_Paice
[jon-lord-wiki]: https://en.wikipedia.org/wiki/Jon_Lord
