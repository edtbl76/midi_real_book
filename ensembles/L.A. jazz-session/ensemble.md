...
This ensemble represents the `L.A. jazz-session` pairing label, a stylistic study lane built from the row context rather than a single fixed band. The target idiom is session / pop, with the surrounding context of Wrecking Crew / Capitol Records session orbit.
...
Tommy Tedesco is the guitar voice for the `L.A. jazz-session` pairing label. In the local ranking corpus, Tommy Tedesco is treated as an everyone-else guitarist because of session Hollywood reading precision, stylistic versatility, clean execution. Their core style vocabulary is jazz, session, studio; in this ensemble, that vocabulary is being aimed at session / pop inside the broader Wrecking Crew / Capitol Records session orbit lane.
...
Barney Kessel is the guitar voice for the `L.A. jazz-session` pairing label. In the local ranking corpus, Barney Kessel is treated as a still damn good guitarist because of swing/bebop session vocabulary, chord melody, bluesy jazz phrasing, big-band guitar authority. Their core style vocabulary is jazz, swing, bebop, session; in this ensemble, that vocabulary is being aimed at session / pop inside the broader Wrecking Crew / Capitol Records session orbit lane.
...
Hal Blaine appears here as the drums voice for the `L.A. jazz-session` pairing label. In this ensemble context, the important traits are the player's role in session / pop, their interaction with the bassist/guitarist core, and the way their vocabulary supports the broader Wrecking Crew / Capitol Records session orbit lane.
...
Leon Russell appears here as the keyboards voice for the `L.A. jazz-session` pairing label. In this ensemble context, the important traits are the player's role in session / pop, their interaction with the bassist/guitarist core, and the way their vocabulary supports the broader Wrecking Crew / Capitol Records session orbit lane.
...
Plas Johnson appears here as the saxophone voice for the `L.A. jazz-session` pairing label. In this ensemble context, the important traits are the player's role in session / pop, their interaction with the bassist/guitarist core, and the way their vocabulary supports the broader Wrecking Crew / Capitol Records session orbit lane.
...
[l-a-jazz-session-wiki]: https://en.wikipedia.org/wiki/L.A._jazz-session
