...
This ensemble represents the `Pink Floyd` pairing label, focusing on the band or collaborator lane that connects the listed players. The target idiom is progressive rock / psychedelic rock, with the surrounding context of Pink Floyd.
