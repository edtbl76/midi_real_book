...
This ensemble represents the `Return to Forever` pairing label, focusing on the band or collaborator lane that connects the listed players. The target idiom is jazz fusion, with the surrounding context of Return to Forever / Mahavishnu Orchestra / Stanley Clarke Band.
