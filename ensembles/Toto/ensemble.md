...
This music lives in the Toto world: L.A. Listen for how the players build the feel together: the groove, the guitar tone, the accents, and the space between parts. The goal is to hear the band as a working ensemble, not just a set of famous songs.

## Players

| Player | Instrument / Role | Wikipedia | Website |
|---|---|---|---|
| [Mike Porcaro](#mike-porcaro) | Bass | [Wikipedia][mike-porcaro-wiki] | — |
| [Steve Lukather](#steve-lukather) | Guitar | [Wikipedia][steve-lukather-wiki] | — |
| [Jeff Porcaro](#jeff-porcaro) | Drums | [Wikipedia][jeff-porcaro-wiki] | — |
| [David Paich](#david-paich) | Keyboards | [Wikipedia][david-paich-wiki] | — |
...
[mike-porcaro-wiki]: https://en.wikipedia.org/wiki/Mike_Porcaro
[steve-lukather-wiki]: https://en.wikipedia.org/wiki/Steve_Lukather
[jeff-porcaro-wiki]: https://en.wikipedia.org/wiki/Jeff_Porcaro
[david-paich-wiki]: https://en.wikipedia.org/wiki/David_Paich
[toto-wiki]: https://en.wikipedia.org/wiki/Toto
