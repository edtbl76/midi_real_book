...
Style target:
Shred Rock Engine. Bass player influence: Billy Sheehan. Guitar player influence: Paul Gilbert, Vinnie Moore. 32-bar hard-rock shred duet. Bass uses Sheehan-style pedal tones, octaves, and controlled aggressive fills. Guitar combines Gilbert-style alternate-picking and string-skipping precision with Moore-style modal shred and melodic hard-rock lead phrasing.
