...
Style target:
Alternate-Picked Fusion Rock. Bass player influence: Dave LaRue. Guitar player influence: Steve Morse. 32-bar precision fusion-rock duet. Bass uses LaRue-style tight pocket, clean melodic support, and wide-interval movement. Guitar uses Morse-style alternate-picked lines, sequenced motifs, and bright fusion-rock harmony.
