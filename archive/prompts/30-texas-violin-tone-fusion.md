...
Style target:
Texas Violin-Tone Fusion. Bass player influence: Kyle Brock. Guitar player influence: Eric Johnson. 32-bar melodic Texas fusion-rock duet. Bass uses Brock-style warm trio support, clean pocket, melodic movement, and harmonically supportive low-end phrasing. Guitar uses Johnson-style violin-tone lead phrasing, pentatonic/fusion lines, open voicings, and lyrical phrasing.
