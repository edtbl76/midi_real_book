...
Style target:
80s Hard-Rock Bite. Bass player influence: Jeff Pilson. Guitar player influence: George Lynch. 32-bar muscular 80s hard-rock duet. Bass uses driving eighths, chromatic walkups, and tight riff doubling. Guitar uses Lynch-style aggressive riffs, wide vibrato, angular pentatonic lines, and dark chord color.
