...
Style target:
Extended-Range Fusion Metal. Bass player influence: Evan Brewer. Guitar player influence: Tosin Abasi, Javier Reyes. 32-bar technical fusion-metal duet. Bass uses Brewer-style extended-range tapping, odd groupings, clean rhythmic precision, low-register weight, and high-register melodic movement. Guitar blends Abasi-style extended-range thump, polymetric riffs, and athletic lead phrasing with Reyes-style syncopated modern prog color and percussive voicings.
