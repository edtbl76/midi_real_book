...
Style target:
Progressive Metal Precision. Bass player influence: John Myung. Guitar player influence: John Petrucci. 32-bar prog-metal duet. Bass uses precise syncopated support, pedal tones, and scalar fills. Guitar uses Petrucci-style tight riffing, odd groupings, and melodic lead statements.
